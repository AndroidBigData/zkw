...
public class AddJobExperienceModel implements IAddJobExperienceModel {
    @Override
    public void getChoiceInfo(String url, Object context, Map<String, String> param, final BasicCallback<ResponseBean<ResumePickerBean>> basicCallback) {
    ...
    @Override
    public void saveExperience(String url, Object context, Map<String, String> param, final BasicCallback<ResponseBean<EmptyBean>> basicCallback) {
