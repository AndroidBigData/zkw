...
//                            it.remove();
    ...
    private void getDeleteData() {
        OkGo.<ResponseBean<SimpleResponse>>post(Config.URL + "api/user/car_del")
                .params("uid",uid)
                .params("id",id)
                ...
                .execute(new JsonCallback<ResponseBean<SimpleResponse>>() {
                    ...
                    public void onSuccess(Response<ResponseBean<SimpleResponse>> response) {
                        ResponseBean<SimpleResponse> data = response.body();
    ...
    private void getData(String uid) {
        OkGo.<ResponseBean<MineShopCartBean>>post(Config.URL + "api/user/car")
                .params("uid", uid)
                .tag(this)
                .cacheMode(CacheMode.NO_CACHE)
                .execute(new JsonCallback<ResponseBean<MineShopCartBean>>() {
                    @Override
